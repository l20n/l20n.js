...
(function (global) {
  ...
  modules.set('lib/context', function () {
    ...
    var Context = (function () {
      ...
      Context.prototype._resolve = function _resolve(langs, keys, formatter, prevResolved) {
        ...
        var resolved = keys.map(function (key, i) {
          ...
          _this4._env.emit('notfounderror', new L10nError('"' + id + '"' + ' not found in ' + lang.code, id, lang), _this4);
    ...
    function reportMissing(keys, formatter, resolved) {
      ...
      keys.forEach(function (key, i) {
        ...
        missingIds.add(id);
        resolved[i] = formatter === _this7._formatValue ? id : {
          value: id,
          attrs: null
        };
      });
    ...
    var Env = (function () {
      ...
      Env.prototype.destroyContext = function destroyContext(ctx) {
        ...
        resList.forEach(function (resId) {
          return deleteIfOrphan(_this8._resCache, lists, resId);
        });
      };
      ...
      Env.prototype._parse = function _parse(syntax, lang, data) {
        ...
        var emit = function (type, err) {
          return _this9.emit(type, amendError(lang, err));
        };
      ...
      Env.prototype._getResource = function _getResource(lang, res) {
        ...
        var saveEntries = function (data) {
          var entries = _this10._parse(syntax, lang, data);

          cache.set(id, _this10._create(lang, entries));
        };

        var recover = function (err) {
          err.lang = lang;
          _this10.emit('fetcherror', err);
          cache.set(id, err);
        };
  ...
  modules.set('bindings/html/remote', function () {
    ...
    var Remote = (function () {
      function Remote(fetch, broadcast, requestedLangs) {
        ...
        this.interactive = documentReady().then(function () {
          return _this11.init(requestedLangs);
        });
      }
      ...
      Remote.prototype.init = function init(requestedLangs) {
        ...
        this.env = new Env(this.defaultLanguage, function () {
          ...
          return _this12.fetch.apply(_this12, [_this12.appVersion].concat(args));
        });
      ...
      Remote.prototype.registerView = function registerView(view, resources) {
        ...
        return this.interactive.then(function () {
          _this13.ctxs.set(view, _this13.env.createContext(resources));
          return true;
        });
      };
      ...
      Remote.prototype.formatValues = function formatValues(view, keys) {
        ...
        return this.languages.then(function (langs) {
          return _this14.ctxs.get(view).resolveValues(langs, keys);
        });
      };
    ...
    function changeLanguages(additionalLangs, requestedLangs) {
      ...
      return this.languages = Promise.all([additionalLangs, prevLangs]).then(function (_ref7) {
        ...
        return negotiateLanguages(_this15.broadcast.bind(_this15, 'translateDocument'), _this15.appVersion, _this15.defaultLanguage, _this15.availableLanguages, additionalLangs, prevLangs, requestedLangs);
      });
    }
  ...
  modules.set('runtime/web/bridge', function () {
    var _getModule19 = getModule('lib/events');

    var emit = _getModule19.emit;
    var addEventListener = _getModule19.addEventListener;
  ...
  modules.set('runtime/web/io', function () {
    var _getModule20 = getModule('lib/errors');

    var L10nError = _getModule20.L10nError;
  ...
  modules.set('runtime/web/index', function () {
    var _getModule21 = getModule('runtime/web/io');

    var fetch = _getModule21.fetch;

    var _getModule22 = getModule('runtime/web/bridge');

    var Client = _getModule22.Client;
    var broadcast = _getModule22.broadcast;

    var _getModule23 = getModule('bindings/html/remote');

    var Remote = _getModule23.Remote;

    var _getModule24 = getModule('bindings/html/view');
