...
(function () {
  ...
  function negotiateLanguages(_ref4, additionalLangs, prevLangs, requestedLangs) {
    var appVersion = _ref4.appVersion;
    var defaultLang = _ref4.defaultLang;
    var availableLangs = _ref4.availableLangs;
  ...
  }).method('changeLanguages', function () {
    return remote.changeLanguages.apply(remote, arguments);
  }).method('formatEntities', function () {
    return remote.formatEntities.apply(remote, arguments);
