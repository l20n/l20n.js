...
(function (global) {
  ...
  modules.set('lib/context', function () {
    ...
    function reportMissing(keys, formatter, resolved) {
      ...
      keys.forEach(function (key, i) {
        ...
        missingIds.add(id);
        resolved[i] = formatter === _this5._formatValue ? id : {
          value: id,
          attrs: null
        };
      });
  ...
  modules.set('lib/env', function () {
    ...
    var removeEventListener = _getModule11.removeEventListener;
    ...
    var Remote = (function () {
      ...
      Remote.prototype.init = function init(requestedLangs) {
        ...
        this.env = new Env(this.defaultLanguage, function () {
          ...
          return _this10.fetch.apply(_this10, [_this10.appVersion].concat(args));
        });
